<h2><a href="https://www.geeksforgeeks.org/problems/convert-the-string1022/1">Convert the string</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size:18px">Given string&nbsp;str, transform it according to the following rules:<br>
